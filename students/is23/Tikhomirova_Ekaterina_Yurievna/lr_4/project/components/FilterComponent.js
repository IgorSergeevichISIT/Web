export class FilterComponent {
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <h5 class="card-title mb-3">
                        <i class="bi bi-funnel me-2"></i>Фильтр участников группы
                    </h5>
                    <div class="mb-3">
                    ...
                    <div class="alert alert-light small mb-0 border">
                        ...
                        Выберите фильтр для отображения определенной категории участников группы
                    </div>
                </div>
            </div>
            `
    ...
    render() {
        ...
        filterSelect.addEventListener('change', (e) => {
            ...
            console.log(`Фильтр изменен: ${newFilter}`);

...
function showMainPage(): void {
    ...
    const container = document.getElementById('main-page') as HTMLElement;
    subjects.forEach(subject => {
        ...
        const button = document.getElementById(`btn-${subject.id}`) as HTMLButtonElement;
        button.addEventListener("click", () => showSubjectPage(subject));
    });
}

function showSubjectPage(subject: Subject): void {
    root.innerHTML = `

...
let members: User[] = []; // Список участников группы
...
function displayGroupMembers(users: User[]) {
...
function applySortFilter() {
    const sortType = (document.getElementById('sort-filter') as HTMLSelectElement).value;
    if (sortType === 'name') {

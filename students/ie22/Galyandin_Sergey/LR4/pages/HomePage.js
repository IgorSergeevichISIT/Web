...
export class HomePage {
    ...
    filterByFriends() {
        ajax.post(urls.getGroupMembers(groupId, filterByFriends), (data) => {
            this.renderData(data.response.items)
        })
    }

    filterByAdmins() {
        ajax.post(urls.getGroupMembers(groupId, filterByAdmins), (data) => {
            this.renderData(data.response.items)
        })
    }
    ...
    renderData(items) {
        ...
        // document.getElementById("filterByFriends").onclick = this.filterByFriends
        // document.getElementById("filterByAdmins").onclick = function(){

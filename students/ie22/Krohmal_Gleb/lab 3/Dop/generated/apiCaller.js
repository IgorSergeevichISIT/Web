...
// Инициализируем API
var testApi = new api_1.TestControllersApi(config);
var userApi = new api_1.UserApi(config);
var weatherApi = new api_1.WeatherForecastApi(config);
// Функция для вызова методов API
function callApis() {
    return __awaiter(this, void 0, void 0, function () {
        var carResponse, weatherResponse, userData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, testApi.getCar(1, 1)];
                case 1:
                    carResponse = _a.sent();
                    console.log('Car Response:', carResponse.data);
                    return [4 /*yield*/, weatherApi.getWeatherForecast()];
                case 2:
                    ...
                    return [4 /*yield*/, userApi.userRegistrationPost(userData)];
                case 3:
                    _a.sent();
